 ...
 * ── 這段註解本身出過錯,留著當紀錄 ────────────────────
 *
 * 原本寫的是「三個實作 + 四個不做」,加起來七個,看起來完整。
 * 但那四個不做的清單裡沒有被動遺漏 —— 它既沒被實作,也沒被列進不做,
 * 就這樣從清單裡消失了,而且三加四等於七讓它看起來沒有缺口。
 * 是擁有者指出「你講一講都自動停下來」才發現的。
 * 一個用加總掩蓋缺項的清單,正是這個模組要抓的東西。
 *
 * ── 這個模組的根據 ─────────────────────────────────
 *
...
export const SHAPES = Object.freeze([
  ...
  'PASSIVE_OMISSION',    // 被動遺漏:宣告要做,然後沒做也沒再提。見 followthrough.js
]);

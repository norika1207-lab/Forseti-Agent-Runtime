...
export const DEFAULT_CONFIG = Object.freeze({
   ...
   */
  // 【已校準】230 秒 = 真實工具間隔的 p90。原本 60 秒,
  // 但真實間隔 p90 就有 3.8 分鐘 —— 用 60 秒當基準,正常的思考與長工具都算成沉默。
  // 一個人的資料,不是通用常數。別的團隊請跑 tools/calibrate.mjs 用自己的分佈。
  heartbeatIntervalMs: 230 * 1000,
  /** 超過這麼久沒有可見動靜,算一次沉默事件 */
  // 10 分鐘。真實工具間隔的 p99 是 178 分鐘,那太長;取 p90 的 2.6 倍。
  // 這個倍數本身沒有資料支撐,是判斷。
  silenceEpisodeMs: 10 * 60 * 1000,
});

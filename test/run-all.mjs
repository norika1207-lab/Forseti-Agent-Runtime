...
const suites = ['conformance', 'signals', 'windows', 'artifact', 'capture', 'shell', 'adapter-claude-code', 'imports', 'cost', 'capsule', 'admission', 'coverage', 'handoff', 'persist', 'drift', 'provenance', 'heartbeat', 'thermometer', 'runtime', 'integration'];
let bad = 0;
